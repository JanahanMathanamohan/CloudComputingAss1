$(document).ready(function(){
    ...
    function fill(data){
        ...
        for(var i = 0; i < item.length;i++){
            var tmp = item[i];
            panel2 += '<div class="panel-body bottomLineR" id="l'+i+'S'+x+'D">';
            ...
            panel2 += '<div class="col-md-4 text-center maxH"><button type="button" id="l'+i+'S'+x+'" class="discardB btn btn-primary ">ADD</button></div></div>';
        }
        panel2 += '</div>';
